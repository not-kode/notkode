...
const Parcerias: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background w-full">
      {/* Hero Section */}
      <section className="relative pt-[120px] pb-[40px] md:pb-[80px] px-4 md:px-8 overflow-hidden bg-background">
  ...
  <Portfolio />
      ...
      {/* Process Section */}
      <section className="relative py-[40px] px-4 md:py-20 md:px-8 overflow-hidden bg-background">
        {/* Background Elements */}
      ...
      {/* CTA Section */}
      <section className="py-[40px] px-4 md:py-20 md:px-8 bg-gradient-to-br from-primary to-secondary">
