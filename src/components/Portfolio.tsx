...
const Portfolio: React.FC = () => {
  ...
  src={project.image}
  alt={project.name}
  className="w-full h-auto md:h-[420px] object-fill hover:scale-105 transition-transform duration-300"
/>
                ...
                <div className="mb-4">
                  ...
                  {t(project.description).length > 200 && (
                    <button
                      ...
                      className="mt-2 transition-colors text-sm font-normal text-sky-200"
                    >
