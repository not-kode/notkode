  ...
  <div className="w-full md:container md:mx-auto text-center">
    <div className="max-w-[1440px] mx-auto p-8 rounded-3xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm mb-12">
        <div className="flex items-center bg-black/20 backdrop-blur-md border border-white/30 rounded-xl px-6 py-4 text-white/90 group hover:bg-black/30 transition-all duration-300">
...
</section><section className="py-[60px] px-[20px] md:py-20 md:px-8 bg-gradient-to-br from-primary to-secondary">
  <div className="w-full md:container md:mx-auto text-center">
    <div className="max-w-[1440px] mx-auto p-8 rounded-3xl">
      <h2 className="font-sora font-bold text-4xl mb-6 text-white">
        {t('cta.empresas.title')}
