  ...
  return <div className="min-h-screen bg-background">
            ...
            <div className="relative inline-block mb-8 animate-fade-in-up">
              ...
              <div className="relative bg-gradient-to-r from-primary/10 via-primary/20 to-primary/10 border border-primary/40 rounded-full px-6 py-2 backdrop-blur-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-[#272B37] dark:text-primary/90 tracking-wide font-mono">{t('empresas.hero.new_title')}</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-8 bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          <div className="absolute top-1/4 left-1/4 w-80 h-80 bg-[#033239] opacity-25 rounded-full blur-3xl animate-glass-float"></div>
          <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-[#033239] opacity-20 rounded-full blur-2xl animate-glass-float delay-1000"></div>
          <div className="absolute bottom-1/3 left-1/3 w-64 h-64 bg-[#033239] opacity-30 rounded-full blur-xl animate-glass-float delay-500"></div>
          <div className="absolute bottom-1/4 right-1/3 w-68 h-68 bg-[#033239] opacity-25 rounded-full blur-2xl animate-glass-float delay-1500"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-[#033239] opacity-15 rounded-full blur-2xl animate-glass-float delay-2000"></div>
        </div>
        <div className="container mx-auto relative z-10">
