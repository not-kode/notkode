  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-8 bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-10 left-0 w-96 h-96 bg-[#86F0FF] opacity-30 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#0C1224] opacity-20 rounded-full blur-2xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-[#86F0FF] opacity-20 rounded-full blur-xl animate-bounce"></div>
          <div className="absolute bottom-1/4 left-0 w-72 h-72 bg-[#0C1224] opacity-15 rounded-full blur-2xl animate-pulse delay-500"></div>
        </div>
        <div className="container mx-auto">
