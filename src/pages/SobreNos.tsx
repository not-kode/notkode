...
<section className="py-12 md:py-20 px-4 relative">
  {/* Intensified animated circles for dark mode only */}
  <div className="absolute inset-0 pointer-events-none z-0 dark:block hidden">
    <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-[#8EE2E5] opacity-20 rounded-full blur-xl animate-[pulse_3s_ease-in-out_infinite]"></div>
    <div className="absolute bottom-1/3 right-1/4 w-40 h-40 bg-[#8EE2E5] opacity-18 rounded-full blur-lg animate-[pulse_4s_ease-in-out_infinite] delay-1000"></div>
    {/* Additional circle for more depth */}
    <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-[#8EE2E5] opacity-15 rounded-full blur-2xl animate-[pulse_5s_ease-in-out_infinite] delay-2000"></div>
  </div>
  ...
  <div className="container mx-auto max-w-6xl relative z-10">
    ...
    <div className="grid md:grid-cols-2 gap-8 md:gap-12">
      {/* Camila */}
      <div className="glass-card text-center backdrop-blur-md bg-white/10 border border-white/20 shadow-xl">
        <div className="flex flex-col items-center">
          <div className="w-32 h-32 rounded-full overflow-hidden mb-6 border-4 border-primary/30 shadow-lg">
          ...
          <h3 className="font-sora font-bold text-xl mb-1 text-white drop-shadow-lg">
            {t('about.founders.camila.name')}
          </h3>
          <div className="text-primary text-sm font-medium mb-4 bg-white/95 rounded-md px-3 py-1.5 shadow-sm">
          ...
          <a href="https://www.linkedin.com/in/gregoriocamila/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-full font-medium transition-all duration-300 hover:scale-105 border border-white/30 backdrop-blur-sm shadow-lg">
      ...
      <div className="glass-card text-center backdrop-blur-md bg-white/10 border border-white/20 shadow-xl">
        <div className="flex flex-col items-center">
          ...
          <a href="https://www.linkedin.com/in/matheustonelotto/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-full font-medium transition-all duration-300 hover:scale-105 border border-white/30 backdrop-blur-sm shadow-lg">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
            </svg>
