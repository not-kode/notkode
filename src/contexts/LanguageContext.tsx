...
const translations = {
  pt: {
    ...
    home: {
      ...
      main_title_1: "Acelere seu negócio",
      main_title_2: "com tecnologia sob medida",
      terminal_echo: "Escolha como podemos ajudar você a crescer",
      companies_title: "Para Empresas",
      companies_desc: "Soluções tecnológicas personalizadas para acelerar seu negócio",
      companies_cta: "Explorar Soluções",
      agencies_title: "Para Agências", 
      agencies_desc: "Seja nosso parceiro e ofereça desenvolvimento sem contratar equipe",
      agencies_cta: "Explorar Parceria",
      hero: {
  ...
  en: {
    ...
    home: {
      ...
      main_title_1: "Accelerate your business",
      main_title_2: "with custom technology",
      terminal_echo: "Choose how we can help you grow",
      companies_title: "For Companies",
      companies_desc: "Customized technological solutions to accelerate your business",
      companies_cta: "Explore Solutions",
      agencies_title: "For Agencies",
      agencies_desc: "Be our partner and offer development without hiring a team",
      agencies_cta: "Explore Partnership",
      hero: {
